...
public function updateItemApproval(Request $request, $id) {
    try {
        ...
        // Validation de la requête pour les valeurs du statut et des clics
        $request->validate([
        ...
        $item->update([
            ...
            'rejected_reason' => ($request->status == "rejected") ? $request->input('rejected_reason') : ''
        ]);
        ...
        ResponseService::successResponse('Item Status and Clicks Updated Successfully');
    } catch (Throwable $th) {
