                    ...
                    <div class="col-12">
                        ...
                        <table class="table-borderless table-striped" aria-describedby="mydesc" id="table_list"
                            ...
                            <tr>
                                ...
                                <th scope="col" data-field="likes" data-sortable="true" data-visible="true">{{ __('Likes') }}</th>
                                <th scope="col" data-field="clicks" data-sortable="true" data-visible="true">{{ __('Clicks') }}</th>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="number" name="clicks" id="clicks" class="form-control" min="0" value="0" />
                        </div>
                    </div>
